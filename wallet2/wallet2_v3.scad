...
module right_side() {
	...
	difference() {
		...
		// finger "holes"
		translate([extra_width+card_width-finger_hole_from_side,0,height/2])
		rotate([90,0,0])
		scale([1,finger_hole_y_scale,2/finger_hole_dia])
		sphere(r=finger_hole_dia/2);

		translate([extra_width+card_width-finger_hole_from_side,card_length+2*head_thickness,height/2])
		rotate([-90,0,0])
		scale([1,finger_hole_y_scale,2/finger_hole_dia])
		sphere(r=finger_hole_dia/2);
	}
